...
int rarchdb_find_entry(struct rarchdb *db, const char *index_name, const void *key, struct rmsgpack_dom_value * out);

int rarchdb_cursor_open(struct rarchdb * db, struct rarchdb_cursor * cursor, rarchdb_query * query);
...
int rarchdb_cursor_read_item(struct rarchdb_cursor *cursor, struct rmsgpack_dom_value *out);
